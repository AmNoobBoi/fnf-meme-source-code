...
class Cache extends MusicBeatState
{
	...
	override function create()
	{
		...
		var menuBG:FlxSprite = new FlxSprite().loadGraphic(Paths.image('LoadingMeme'));
		menuBG.antialiasing = true;
		menuBG.screenCenter();
		add(menuBG);

		shitz = new FlxText(1010, 660, 0, "Loading MEME...", 1000);
		shitz.antialiasing = true;
		shitz.scrollFactor.set();
		shitz.setFormat("FONT GAMER OSD Mono", 32, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(shitz);
