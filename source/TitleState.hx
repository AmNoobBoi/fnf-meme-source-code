	...
	override function beatHit()
	{
		...
		if (!closedState)
		{
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['Psych Engine Source Code'], 15);
					#else
				...
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('AmNoobBoi', 15);
					#else
					addMoreText('AmNoobBoi');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['There are really', 'cool stuff in here'], -40);
					#else
					createCoolText(['There are really', 'cool stuff in here'], -40);
					#end
				case 7:
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Source'); // credTextShit.text += '\nFunkin';
				case 16:
					addMoreText('Code');
				case 17:
					skipIntro();
